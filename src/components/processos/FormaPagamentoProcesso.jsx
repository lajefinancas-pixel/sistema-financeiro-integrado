...
export default function FormaPagamentoProcesso({ formulario, somenteLeitura, definir, dadosBancarios, beneficiarioSugerido = "", documentoSugerido = "", valorSugerido = 0 }) {
