...
import {
  COR_NEUTRA_SECRETARIA,
  carregarOrganizacaoSecretarias,
  mapaDeCoresDasSecretarias,
...
function GrupoContas({ grupo, cor = COR_NEUTRA_SECRETARIA, recolhido = false, sempreAberto = false, onAlternar, marcadas, multipla, desabilitado, onEscolher }) {
  ...
  return <section className="overflow-hidden rounded-lg border border-black/5">
    <button type="button" onClick={onAlternar} disabled={sempreAberto} aria-expanded={!recolhido}
      ...
      style={{ backgroundColor: `${cor}14`, borderLeft: `4px solid ${cor}`, color: cor }}>
