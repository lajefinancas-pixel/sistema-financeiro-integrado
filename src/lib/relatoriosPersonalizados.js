...
export const FONTES = [
  ...
  {
    id: "baixas",
    nome: "Baixas de pagamentos",
    descricao: "Pagamentos efetivamente realizados, inclusive avulsos e estornos.",
    temPeriodo: true,
    rotuloPeriodo: "Data real do pagamento",
    colunas: [
      { chave: "fornecedor", label: "Fornecedor", peso: 28 },
      { chave: "conta", label: "Conta bancária", peso: 26 },
      { chave: "data", label: "Data", tipo: "data", peso: 12 },
      { chave: "valor", label: "Valor", tipo: "moeda", somavel: true, peso: 16 },
      { chave: "status", label: "Situação", peso: 12 },
      { chave: "origem", label: "Origem", peso: 12 },
      { chave: "documento", label: "Documento", peso: 18 },
      { chave: "observacao", label: "Observação", peso: 24 },
    ],
    padrao: ["fornecedor", "conta", "data", "valor", "status", "origem"],
    filtros: [
      { id: "fornecedor", label: "Fornecedor", campo: "fornecedor" },
      { id: "conta", label: "Conta bancária", campo: "conta" },
      { id: "status", label: "Situação", campo: "status" },
    ],
    agrupamentos: [
      { id: "fornecedor", label: "Fornecedor", campo: "fornecedor" },
      { id: "conta", label: "Conta bancária", campo: "conta" },
    ...
    campoValor: "valor",
    campoData: "data",
    linhas: (bases) => bases?.baixas?.baixas ?? [],
  },
  {
    id: "tarefas",
    nome: "Tarefas",
